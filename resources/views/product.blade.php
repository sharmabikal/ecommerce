	   ...
	   <div class="products-page">
			<div class="products">
				...
				<div class="latest-bis">
					<img src="{{asset('assets/images/l4.jpg')}}" class="img-responsive" alt="" />
					<div class="offer">
						<p>40%</p>
			...
			<div class="new-product">
				<div class="new-product-top">
					...
					<p class="back"><a href="{{url('/')}}">Back to Previous</a></p>
				...
				<div class="mens-toolbar">
                 <div class="sort">
               	   <div class="sort-by">
			            ...
			            <a href=""><img src="{{asset('assets/images/arrow2.gif')}}" alt="" class="v-middle"></a>
	                   </div>
	    		     </div>
							...
							<a class="cbp-vm-image" href="single.html">
							 ...
							 <div class="view view-first">
								...
								<div class="product_image">
									<img src="{{asset('assets/images/p3.jpg')}}" class="img-responsive" alt=""/>
									<div class="mask">
   ...
   <!-- content-section-ends -->
		...
		<div class="container">
			<h3 class="like text-center">Featured Collection</h3>        			
				     <ul id="flexiselDemo3">
						<li><a href="single.html"><img src="{{asset('assets/images/l4.jpg')}}" class="img-responsive"/></a>
